...
UserDTO userDTO = userDAO.selectUser(id);
    ...
    int bbsno = 0;  
    if(request.getParameter("bbsno") != null){  //전달 받은 게시물 번호가 있다면 전달 받음
    ...
    bbsDTO = bbsDAO.getBbs(bbsno);  //불러온 함수를 다른 인스턴스에 담아 저장 
%>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="bbsview.css">
<script
	src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
<script type="text/javascript" src="bbsview.js"></script>
<link rel="stylesheet"
			...
			<form method="post" action="writeAction.jsp">
				<table>
					...
					<tr class="bbs-title-line">
						...
						<td colspan="2" class="bbs-right-line"><%= bbsDTO.getBbstitle() %></td>
					</tr>
					<tr class="bbs-title-line">
					    <td class="bbs-lift-line">작성자</td>
						<td colspan="2" class="bbs-right-line"><%= bbsDTO.getCust_nickname() %></td>
					</tr>
					<tr class="bbs-title-line">
					    <td class="bbs-lift-line">요리 장르</td>
						<td colspan="2" class="bbs-right-line"><%=bbsDTO.getBbs_cookinggenre() %></td>
					</tr>
					<tr class="bbs-title-line">
					    <td class="bbs-lift-line">내용</td>
						<td colspan="2" class="bbs-right-line"><%= bbsDTO.getBbscontent() %></td>
					</tr>
				</table>
				<div class="write-btn-box">
					<a href="bbs.jsp" class="bbs-mokrok-btn">목록</a>
					<%
					   if(id != null && id.equals(bbsDTO.getCust_id())){  // 로그인이 되어 있는 상태에서 버튼을 보이게 하기 위함
						   %>
						   <a href="bbssujung.jsp?bbsno=<%= bbsno %>" class="bbs-sujung-btn">수정</a>
						   <a href="bbsdeleteAction.jsp?bbsno=<%= bbsno %>" class="bbs-delete-btn">삭제</a>
						   <%
					   }
					%>
				</div>
