...
if(request.getParameter("gdsRe_num") != null){
	gdsRe_num = Integer.parseInt(request.getParameter("gdsRe_num"));
}
...
<title>NIPPONSIK 리뷰 수정 페이지</title>
...
<header>
	...
	<section class="totalsection">
		<div class="wrapsection">
			...
			<form action="modify.gdsReply" method="post" enctype="multipart/form-data">
			<input type="hidden" name="gdsReply_safac1" value="<%=gdsRe_safac%>" id="safac4">
				...
				<div class="myreview-middle-box">
					...
					<div class="product-info-box">
						...
						<div class="product-rating-star">
							...
							<input type="hidden" name="gdsRe_star" value="<%=gdsRe_star %>" id="hiddenstar1">
							<input type="hidden" name="gdsRe_star" value="<%=gdsRe_star %>" id="hiddenstar">
						</div>
					</div>
				</div>
				<!-- 상세 리뷰 설명 -->
				...
				<div class="myreview-content-box">
					...
					<div class="myreview-content-right">
						<textarea rows="5" placeholder="상품 품질에 대한 고객님의 솔직한 리뷰를 남겨주세요." maxlength="500" name="gdsRe_content"><%=gdsRe_content %></textarea>
					</div>
				</div>
				<!-- 사진 업로드 부분 -->
				<div class="myreview-upload-box">
					...
					<div class="myreview-upload-right">
						<div class="myreview-upload-inner">
							...
							<span class="upload-count"><%=gdsRe_imgFile %></span>
...
<p>email: help@nipponsik.com</p>
	...
	function blank_check(){
	 ...
	 window.onload = function(){
		 var getSafac = $("#safac5").val();
		 
		 if(getSafac == $("#safac1").val()){
			 $("#safac1").prop("checked");
		 }else if(getSafac == $("#safac2").val()){
			 $("#safac2").prop("checked");
		 }else{
			 $("#safac3").prop("checked");
		 }
