	...
	<form action="loginprocess.jsp" method="post">
		<div class="total">
			<div class="topcol">
				<div class="topheader">
					<ul>
						...
						<li><a href="#a">패스워드 재발행 |</a></li>
						<li><a href="#a">비회원 예약 확인 |</a></li>
					</ul>
				</div>
				<div class="logo">
			...
			<div class="bottomcol">
				...
				<div class="idpwinfo">
					<div class="id">
						<input type="text" name="idbox" placeholder="ID 입력">
					</div>
					<div class="pw">
						<input type="password" name="pwbox" placeholder="패스워드 입력">
					</div>
				</div>
				<div class="autologin">
					<input type="checkbox" name="autologinbox"> 다음부터 자동로그인
				</div>
				<div class="loginbtn">
					<div class="loginbox">
				...
				<div class="forgetbtn">
					<div class="forgetbox">
						<a href="#a">비밀번호를 잃어버리신 경우</a>
					</div>
				</div>
				<div class="notmembership">
					<div class="line"></div>
					<div class="notmembertitle">아직 회원이 아닌 분</div>
					<div class="notmemberbtn">
						<a href="gaipsujung.html">회원가입(무료)</a>
					</div>
					<div class="reserbtn">
						<a href="mypage.jsp">예약 확인</a>
					</div>
				</div>
			</div>
			<div class="login_sns">
				<h2 class="login_sns_title">
					<div class="line"></div>
					<span>SNS 로그인</span>
				</h2>
				<ul>
					<li><a href="#a"><img src="loginpagepicture/kakao.PNG"></a></li>
					<li><a href="#a"><img src="loginpagepicture/naver.PNG"></a></li>
					<li><a href="#a"><img src="loginpagepicture/facebook.PNG"></a></li>
					<li><a href="#a"><img src="loginpagepicture/google.PNG"></a></li>
				</ul>
			</div>
		</div>
	</form>
