...
<meta charset="UTF-8" />
<title>MVC 게시판</title>
<link rel="stylesheet" type="text/css" href="qna_board_reply.css">
<link rel="stylesheet"
...
<body>
	...
	<section class="middlesection">
		<article class="board-box">
			<p class="box-title">Q&A 댓글</p>
			<form method="post" action="boardReplyPro.bo"
				 name="boardform">
				...
				<table>
					...
					<tr>
						<td colspan="2"><input type="text" name="BOARD_SUBJECT"
							class="boardsusik" maxlength="50" placeholder="글 제목"
							required="required"></td>
					</tr>
					<tr>
						<td colspan="2"><textarea name="BOARD_CONTENT"
								maxlength="2048" placeholder="글 내용" class="write-area"
								required="required"></textarea></td>
					</tr>
				</table>
				<div class="write-btn-box">
					<input type="submit" value="글쓰기" class="writebtn"> <input
						type="reset" value="다시쓰기" class="writebtn">
				</div>
			</form>
		</article>
	</section>
