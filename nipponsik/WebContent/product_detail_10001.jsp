...
<%
  ...
  ArrayList<QnaGoodsDTO> qnaList = (ArrayList<QnaGoodsDTO>)request.getAttribute("qnaList");
		...
		<div class="topnavi">
			<div class="categorybtn">
				...
				<div class="smallcategory">
					<ul>
						<li><a href="product.nipponsik?cate_list=101">자사식품세트</a></li>
				...
				<div class="rightup">
					...
					<nav class="toprightnavi">
						<ul class="toprightnavitul">
							<li class="mycart"><a href="#a"><i class="xi-cart-o"></i><br>장바구니</a></li>
							<li class="mypage"><a href="mypageAction.jsp"><i
					...
					<nav class="mainnavi">
						<ul class="mainnavicategory">
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=101" class="firsttab">자사식품세트</a>
								<ul class="fixdetailcategorytul">
									<li><a href="#a" class="secondtab">봉지라면</a></li>
									<li><a href="#a" class="secondtab">컵라면</a></li>
									<li><a href="#a" class="secondtab">냉면</a></li>
									<li><a href="#a" class="secondtab">자장면</a></li>
									<li><a href="#a" class="secondtab">기타</a></li>
								</ul></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=102" class="firsttab">면류</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=103" class="firsttab">과자,스위트</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=104" class="firsttab">식재료</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=105" class="firsttab">조미료</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=106" class="firsttab">술</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=107" class="firsttab">차</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=108" class="firsttab">음료</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=109" class="firsttab">가공식품</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=110" class="firsttab">고기</a></li>
							<li class="mainnavicategorybox"><a
								href="product.nipponsik?cate_list=111" class="firsttab">건어물</a></li>
						</ul>
					</nav>
				</div>
			</div>
	...
	<div class="totalsection">
		<div class="product-top">
			...
			<div class="product-detail">
				...
				<div class="product-detail-baesong">
					...
					<div class="baesong-when">까지 도착</div>
				</div>
				...
				<form action="cartInsertAction.jsp" method="post">
					<input type="hidden" name="goods_price" id="sell_price">
					<input type="hidden" name="sum_goods_price" id="sum" value="1">
		...
		<div class="product-review-box">
			...
			<div class="review-box">
				<div class="review-Writer">이범식/2022-01-31</div>
				<div class="review-product-name"><%= productDTO.getGoods_name() %></div>
				<div class="review-content">이거 진짜 맛있는 듯?</div>
			</div>
			<!-- 상품 문의 부분 -->
...
<p>email: help@nipponsik.com</p>
	...
	<script>
        ...
        $(".amount-up").click(function(){  // 상품 수량 input 값을 가감하는 함수
        	...
        	$("#sum-price").html(totalPrice);  //총 가격 출력
