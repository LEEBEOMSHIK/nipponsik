...
<body>
	...
	<section class="middlesection">
		<article class="bbs-box">
			...
			<form method="post" action="bbssujungAction.jsp?bbsno=<%= bbsno %>">
				<table>
					<tr class="bbs-mokrok">
					...
					<tr>
						<td colspan="2"><input type="text" name="bbstitle"
							class="bbstitle" maxlength="50" value="<%= bbsDTO.getBbstitle()%>"></td>
					</tr>
					<tr>
						<td class="cooking_genre">요리 장르</td>
						<td><select class="cooking_genre-select" name="cooking_genre">
								<option value="찜">찜</option>
								<option value="전골">전골</option>
								<option value="구이">구이</option>
								<option value="찌게">찌게</option>
						</select></td>
					</tr>
					<tr>
						<td colspan="2"><textarea name="bbscontent" maxlength="2048"
								 class="write-area"><%= bbsDTO.getBbscontent()%></textarea></td>
					</tr>
				</table>
				<div class="write-btn-box">
				    <input type="submit" value="수정" class="bbs-sujung-btn">
