...
<%
   List<ProductDTO> list = (List) request.getAttribute("priceFilterList");
	int count = 0;
	if(request.getAttribute("priceFilterListCount") != null){
		count = Integer.parseInt(request.getAttribute("priceFilterListCount").toString());
	}
...
<body>
	...
	<section class="sectiontopnavi">
		...
		<span>></span>
		<span class="redfont">가격 검색 결과</span>
	</section>
	<section class="searchoption">
		...
		<span class="optionbox">
			...
			<input type="hidden" name="goods_category" value="">
