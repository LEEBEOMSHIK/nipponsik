...
<link rel="stylesheet" type="text/css" href="qna_board_write.css">
...
<!-- 게시판 등록 -->
	<section class="middlesection">
		<article class="board-box">
			<p class="box-title">Q&A 게시판 수정</p>
			<form method="post" action="boardModifyPro.bo" name="modifyform">
				<input type = "hidden" name = "BOARD_NUM" value = "<%=article.getBOARD_NUM()%>"/>
				<table>
					<tr class="board-mokrok">
						<td colspan="2">글쓰기 양식</td>
					</tr>
					<tr>
						<td id="fileUpload">파일 첨부</td>
						<td><%
					...
					<tr>
						<td colspan="2"><input type="text" name="BOARD_SUBJECT"
							class="boardsusik" maxlength="50" placeholder="글 제목" value="<%=article.getBOARD_SUBJECT()%>" required="required"></td>
					</tr>
					<tr>
						<td colspan="2"><textarea name="BOARD_CONTENT" maxlength="2048"
								placeholder="글 내용" class="write-area" required="required"><%=article.getBOARD_CONTENT()%></textarea></td>
					</tr>
				</table>
				<div class="write-btn-box">
				    <a href="javascript:modifyboard()" class="writebtn">수정</a>
			        <a href="javascript:history.go(-1)" class="writebtn">뒤로</a>
				</div>
			</form>
		</article>
	</section>
