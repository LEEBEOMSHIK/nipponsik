...
<body>
	...
	<section class="middlesection">
		<article class="board-box">
			...
			<form method="post" action="boardWritePro.bo" enctype="multipart/form-data" name="boardform">
				<input type="hidden" name="cust_id" value="<%=userDTO.getCustom_id()%>">
				<table>
					...
					<tr>
						<td colspan="2"><input type="text" name="BOARD_SUBJECT"
							class="boardsusik" maxlength="50" placeholder="글 제목" required="required"></td>
					</tr>
					<tr>
						<td colspan="2"><textarea name="BOARD_CONTENT" maxlength="2048"
								placeholder="글 내용" class="write-area" required="required"></textarea></td>
					</tr>
				</table>
